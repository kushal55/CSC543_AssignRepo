       ...
       try
        {
            ...
            String s21 = "And immediately there was in their synagogue a man with an unclean spirit.";            		
            System.out.println("\n" + s21 + " : " + toHexString(getSHA(s21))); 
            
            String s22 = "And the whole city was gathered together about the door."; 
            System.out.println("\n" + s22 + " : " + toHexString(getSHA(s22))); 
            
            String s23 = "And Simon and those who were with him pursued him,"; 
            System.out.println("\n" + s23 + " : " + toHexString(getSHA(s23))); 
            
            String s24 = "And he sternly charged him, and sent him away at once,"; 
            System.out.println("\n" + s24 + " : " + toHexString(getSHA(s24))); 
            
            String s25 = "But he went out and began to talk freely about it, and to spread the news, so that Jesus could no longer openly enter a town, but was out in the country; and people came to him from every quarter.\r\n"
            		+ ""; 
            System.out.println("\n" + s25 + " : " + toHexString(getSHA(s25))); 
